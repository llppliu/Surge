 ...
 *
 * [Panel]
 * youtube = script-name=youtube_premium_check, title="YouTube", update-interval=1
 *
 * [Script]
 * youtube = type=generic, script-path=https://gist.githubusercontent.com/Hyseen/5ae36a6a5cb5690b1f2bff4aa19c766f/raw/youtube_premium_check.js?version=1633074636264, argument=title=YouTube
 *
...
const DEFAULT_OPTIONS = {
  title: 'YouTube',
  availableContent: '解锁：#REGION_FLAG# #REGION_NAME#',
  availableIcon: '',
  availableIconColor: '',
  availableStyle: '',
