...
const DEFAULT_OPTIONS = {
  ...
  onlyOriginalIcon: 'lock.desktopcomputer',
  notAvailableContent: '失败',
  notAvailableIconColor: '#FF0000',
  errorContent: '失败',
  notAvailableIcon: 'desktopcomputer.trianglebadge.exclamationmark',
  errorIcon: 'desktopcomputer.trianglebadge.exclamationmark',
  errorStyle: 'desktopcomputer.trianglebadge.exclamationmark',
}
