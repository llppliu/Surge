/*
[Script]
DNS = type=generic,timeout=10,script-path=DNS.js
// use "title" or "icon" or "color" or "server" in "argument":
// DNS = type=generic,timeout=10,script-path=DNS.js,argument=title=DNS FLush&icon=arrow.clockwise&color=#3d3d5b&server=false

[Panel]
DNS = script-name=DNS,update-interval=600
*/
